...
const ConnectionStatus = ({ apiUrl }) => {
  ...
  return (
    ...
    >
      ...
      {error && (
        <div className="text-red-600 overflow-auto max-h-20">{error}</div>
      )}
            ...
            {filtered.map((p) => (
              <tr key={p.id} className="border-b hover:bg-gray-100">
                ...
                <td className="p-2 relative group">
                  ...
                  <div
                    className="fixed z-50 hidden group-hover:block bg-white border p-1 rounded shadow-xl"
